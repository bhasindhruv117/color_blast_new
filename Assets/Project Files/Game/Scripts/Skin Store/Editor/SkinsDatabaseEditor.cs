...
namespace Watermelon.SkinStore
{
    ...
    public class SkinsDatabaseEditor : Editor
    {
        ...
        public void RecalculateProducts()
        {
            ...
            for (int i = 0; i < tabsArrayProp.arraySize; i++)
            {
                ...
                for (int k = 0; k < products.Count; k++)
                {
                    ...
                    if (uniqueId.stringValue.Equals(string.Empty))
                    {
                        uniqueId.stringValue = UniqueIDUtils.GetUniqueID();
                    }
                }
                ...
                if (tabUniqueId.stringValue.Equals(string.Empty))
                {
                    tabUniqueId.stringValue = UniqueIDUtils.GetUniqueID();
                }
            }
        }
        ...
        {
            EditorGUILayoutCustom.BeginBoxGroup("Tabs");
